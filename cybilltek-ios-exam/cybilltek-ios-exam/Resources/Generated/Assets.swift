...
internal enum Asset {
  ...
  internal enum Colors {
    ...
    internal static let subtext = ColorAsset(name: "subtext")
    internal static let success = ColorAsset(name: "success")
    internal static let text = ColorAsset(name: "text")
    internal static let themeAccent = ColorAsset(name: "theme_accent")
    internal static let themeMain = ColorAsset(name: "theme_main")
    internal static let themeSecondary = ColorAsset(name: "theme_secondary")
  }
